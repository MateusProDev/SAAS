  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h1 style={{ color: '#4a4e69', fontSize: 28, marginBottom: 24, textAlign: 'center', letterSpacing: 1 }}>Acesse sua conta</h1>
        ...
        <p style={{ color: '#888', fontSize: 15, marginTop: 18, textAlign: 'center' }}>
          Não tem conta? <Link href="/register" style={{ color: '#4a4e69', fontWeight: 600 }}>Criar conta</Link>
        </p>
      </div>
    </div>
  );
