    ...
    <div className={styles['home-root']}>
      ...
      <section className={styles['home-section']} id="templates">
        ...
        <CarouselClient
          ...
          swipeable
          emulateTouch
          className={styles['home-carousel']}
        >
          <div className={styles['home-template-card']}>
            ...
            <p>Foco em agendamento, redes sociais e visual moderno para barbearias e salões.</p>
          </div>
          <div className={styles['home-template-card']}>
            <img src="https://images.unsplash.com/photo-1461749280684-dccba630e2f6?auto=format&fit=crop&w=400&q=80" alt="Comercial" style={{borderRadius:12,marginBottom:12}}/>
            <h3><span className={styles['icon-left']}><MdOutlineDesignServices /></span>Comercial</h3>
            <p>Ideal para empresas, escritórios e negócios que querem presença digital forte.</p>
          </div>
          <div className={styles['home-template-card']}>
            <img src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=400&q=80" alt="Agência de Viagem" style={{borderRadius:12,marginBottom:12}}/>
            <h3><span className={styles['icon-left']}><MdOutlineDesignServices /></span>Agência de Viagem</h3>
            <p>Divulgue pacotes, destinos e conquiste clientes com um site visualmente atraente.</p>
          </div>
          <div className={styles['home-template-card']}>
            <img src="https://images.unsplash.com/photo-1465101046530-73398c7f28ca?auto=format&fit=crop&w=400&q=80" alt="Landing Page" style={{borderRadius:12,marginBottom:12}}/>
